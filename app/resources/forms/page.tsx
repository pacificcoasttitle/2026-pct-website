...
export default function FormsPage() {
  ...
  return (
    <main className="min-h-screen bg-white">
      ...
      <PageHero
        label="Forms Library"
        title="Blank Documents"
        subtitle="Download the forms you need. All documents are available in PDF format for immediate use."
      />
                  ...
                  <div className="border-t border-gray-100 p-4">
                    <ul className="space-y-2">
                      {category.forms.map((form, index) => (
                        <li key={index}>
                          <a
                            href={`https://documents.pct.com/industry-documents/blank-forms/${form.file}`}
                            target="_blank"
