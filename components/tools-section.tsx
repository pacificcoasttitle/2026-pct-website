    ...
    <section id="tools" className="py-20 bg-[#f8f9fa]">
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center mb-12">
          <p className="text-sm text-gray-500 italic mb-2">Estimate Your Costs</p>
        ...
        <div className="mb-12">
          <div className="bg-white rounded-xl shadow-lg p-6 sm:p-8 border border-gray-100">
            <div className="flex items-center gap-3 mb-6 pb-4 border-b border-gray-100">
              ...
              <div>
                <h3 className="text-xl font-bold text-secondary">Title & Escrow Fee Calculator</h3>
                <p className="text-gray-500">Estimate your closing costs for California transactions</p>
              </div>
            </div>
            <RateCalculator />
          </div>
              ...
              <div className="flex items-start gap-4">
                ...
                <div className="flex-1">
                  ...
                  <p className="text-gray-500 leading-relaxed mb-3">
                    Property-specific title information with transfer tax rates and local requirements by city.
                  </p>
            ...
            <div className="bg-white rounded-xl shadow-md hover:shadow-lg transition-all duration-300 p-6 border border-gray-100 h-full">
              <div className="flex items-start gap-4">
                ...
                <div className="flex-1">
                  ...
                  <p className="text-gray-500 leading-relaxed mb-3">
                    Download escrow instructions, disclosures, and essential documents for your transactions.
                  </p>
                  <div className="flex items-center text-primary font-semibold group-hover:gap-2 transition-all">
                    Download Forms
                    <ArrowRight className="w-4 h-4 ml-1 group-hover:translate-x-1 transition-transform" />
